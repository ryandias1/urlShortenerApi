...
urlRoutes.patch("/expire/:short", authMiddleware, (req: Request, res: Response) => urlController.expired(req, res))
urlRoutes.get("/stats/:short", authMiddleware, (req: Request, res: Response) => urlController.getUrlStats(req, res))
